  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-12"
      >
        <a href={PROFILES.resumePath} target={"_blank"} rel="noreferrer">
...
function RenderDescription(props: { finishedLoading: boolean }) {
  const { description } = PROFILES.myName;
